      ...
      <form action="proses_add_artikel.php" method="post" class="space-y-6"> 
        ...
        <div> 
          ...
          <input type="text" id="nama_artikel" name="nama_artikel" required 
            class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 dark:text-white focus:outline-none focus:ring focus:border-blue-500"> 
        </div> 
        ...
        <div> 
          ...
          <textarea id="isi_artikel" name="isi_artikel" rows="5" required 
            class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 dark:text-white focus:outline-none focus:ring focus:border-red-500"></textarea> 
        </div> 
